...
//       let lastEvent = null;
//       if (e.type !== "mouseout") {
//         active = this.getElementsAtEventForMode(
//           e,
//           hoverOptions.mode,
//           hoverOptions,
//           useFinalPosition,
...
//         Math.max(furthestLimits.r - this.width, 0) / Math.sin(furthestAngles.r);
//       let radiusReductionTop = -furthestLimits.t / Math.cos(furthestAngles.t);
//       let radiusReductionBottom =
//         -Math.max(furthestLimits.b - (this.height - this.paddingTop), 0) /
...
//       const maxBottom =
//         this.height - this.paddingTop - bottomMovement - this.drawingArea;
//       this.xCenter = Math.floor((maxLeft + maxRight) / 2 + this.left);
//       this.yCenter = Math.floor(
//         (maxTop + maxBottom) / 2 + this.top + this.paddingTop,
//       );
//     }
//     getIndexAngle(index) {
