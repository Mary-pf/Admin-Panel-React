...
const AddCart = () => {
  ...
  const handleChangeSelectedProduct = async (e, formik) => {
    ...
    if (res.status === 200) {
      ...
      setGuaranties(
        product.guaranties.map((g) => ({ name: g.title, value: g.id })),
      );
    }
  };
                  ...
                  <div className="row my-3 justify-content-center">
                    ...
                    <div className="col-12 col-md-4 col-lg-2 my-1">
                      <SelectSearch
                        options={guaranties}
                        placeholder="گارانتی"
                        onChange={(e) => formik.setFieldValue("guaranty_id", e)}
                      />
                      <br />
                      <ErrorMessage
                        name="guaranty_id"
                      ...
                      >
                        <div className="input-group my-3 dir_ltr">
                          <span className="input-group-text text-end font_08 w-100 text_truncate">
                            ...
                            {product.guaranty?.title}) ({product.count} عدد)
                            <i
